...
class PageeTest extends Testcase
{
    ...
    public function test_sets_and_gets_limit_key()
    {
        ...
        $expect = 'items_per_page';

        // Act
        $pagee->setLimitKey($expect);

        $actual = $pagee->getLimitKey();
    ...
    public function test_sets_and_gets_page_key()
    {
        ...
        // Act
        $pagee->setPageKey($expect);

        $actual = $pagee->getPageKey();
    ...
    public function test_sets_and_gets_total()
    {
        ...
        // Act
        $pagee->setTotal($expect);

        $actual = $pagee->getTotal();
